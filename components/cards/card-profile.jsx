  ...
  return (
    <div className="row mb-30_reset">
          ...
          <div className="card__item three">
            <div className="card_body space-y-10">
              ...
              <div className="card_head">
                <Image src={`/assets/images/items/item_${val.img}.png`} layout="fill" alt="nftimage" />
      ...
      _bold">
                                      ...
                                      <Link href="#"><a className="btn btn-dark w-full">
                                        Watch the listings
                                        </a></Link>
                                    </div>
                                  </div>
              ...
              <h6 className="card_title">
                <Link href="item-details"><a className="color_black">
                  {val.title}
                  </a></Link>
              </h6>
                ...
                <div
                  ...
                  <div className="creators space-x-10">
                    <div className="avatars -space-x-20">
                      <Link href="profile"><a className='position-relative'>
                        <Image
                          src={`/assets/images/avatars/avatar_${val.avatar_img1}.png`}
                          alt="Avatar"
                          width={32}
                          height={32}
                      ...
                      <Link href="profile"><a>
                        <Image
                          src={`/assets/images/avatars/avatar_${val.avatar_img2}.png`}
                          alt="Avatar"
                          width={32}
                          height={32}
                          className="avatar avatar-sm"
                  ...
                  <Link href="#" className="space-x-3"><a>
