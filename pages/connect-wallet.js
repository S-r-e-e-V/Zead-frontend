  ...
  return (
    <div className="effect">
      <div className="container">
        <div>
          <Link href="/"><a className="btn btn-white btn-sm mt-20">
            Back to home
            </a></Link>
          <div className="hero__wallets pt-100 pb-50">
            <div className="space-y-20 d-flex flex-column align-items-center">
              <div className="logo position-relative">
                <Image src={`/assets/images/icons/zead-logo-black.svg`} layout="fill" alt="ImgPreview" />
              </div>
                          ...
                          <div>
                            ...
                            <div className="space-y-20">
                              ...
                              <div className="d-flex justify-content-center space-x-20">
                                <Link href="marketplace"><a className="btn btn-dark">
                                  Discover Assets
                                  </a></Link>
                                <Popup
                                  className="custom"
                                    ...
                                    <div
                                      ...
                                      <div>
                                        ...
                                        <div className="space-y-20">
                                          ...
                                          <Link href="#"><a className="btn btn-lg btn-primary">
                                            Try again
                                            </a></Link>
                                        </div>
                                      </div>
